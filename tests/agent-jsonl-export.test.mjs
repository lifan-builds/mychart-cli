...
test('JSONL dedupe preserves cross-day records and is stable under reversed input', () => {
  const records = [
    { id: 'older', patient: { key: 'demo-child' }, category: 'test-results', title: 'Panel', date: '2026-07-10', rawText: 'older', sourceUrl: 'https://example.test/details?eorderid=1&pageMode=1', extractedAt: '2026-07-10T12:00:00Z' },
    { id: 'newer-short', patient: { key: 'demo-child' }, category: 'test-results', title: 'Panel', date: '2026-07-11', rawText: 'x', sourceUrl: 'https://example.test/details?pageMode=2&eorderid=1', extractedAt: '2026-07-11T12:00:00Z' },
    { id: 'newer-best', patient: { key: 'demo-child' }, category: 'test-results', title: 'Panel', date: '2026-07-11', rawText: 'more complete same-day value', sourceUrl: 'https://example.test/details?eorderid=1', extractedAt: '2026-07-11T13:00:00Z' },
  ];
