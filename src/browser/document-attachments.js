...
import { ensurePrivateDirectory, writePrivateFile } from '../core/private-files.js';
...
async function downloadScanAttachment(page, scanButton, {
  ...
  await ensurePrivateDirectory(attachmentsDir);
  ...
  await writePrivateFile(filePath, download.buffer, {});
